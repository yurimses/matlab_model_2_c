/*
 * File: _coder_classifyWaterflow_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "classifyWaterflow",                                  /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void classifyWaterflow_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  value = emlrt_marshallIn(&st, emlrtAliasP(prhs), "value");
  /* Invoke the target function */
  value = classifyWaterflow(value);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(value);
}
...
void classifyWaterflow_atexit(void)
{
  ...
  classifyWaterflow_xil_terminate();
  classifyWaterflow_xil_shutdown();
...
/*
 * File trailer for _coder_classifyWaterflow_api.c
 *
 * [EOF]
 */
